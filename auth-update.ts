...
${SET_CONFIG} ext::auth::UIConfig::redirect_to := "${new URL("auth/builtin/callback", baseUrl)}";
${SET_CONFIG} ext::auth::UIConfig::redirect_to_on_signup := "${new URL("auth/builtin/callback?isSignUp=true", baseUrl)}";
`;
